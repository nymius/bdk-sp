use bdk_silentpayments::bitcoin::{
    absolute::LockTime,
    bip32,
    key::{Keypair, Parity},
    ...
    taproot::Signature,
    transaction::Version,
    Address, Amount, BlockHash, Network, OutPoint, PrivateKey, Sequence, TapTweakHash, Transaction,
...
use bdk_silentpayments::{
    code::SilentPaymentCode, receive::Scanner, send::XprivSilentPaymentSender,
};
...
) -> Result<(Txid, BlockHash, TxOut), Box<dyn Error>> {
