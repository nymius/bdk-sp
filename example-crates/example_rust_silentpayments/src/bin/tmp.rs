...
fn get_sp_keys() -> (SilentPaymentAddress, SecretKey, SecretKey) {
    ...
    let _silent_payment_string: &str = "sprt1qqw7zfpjcuwvq4zd3d4aealxq3d669s3kcde4wgr3zl5ugxs40twv2qccgvszutt7p796yg4h926kdnty66wxrfew26gu2gk5h5hcg4s2jqyascfz";
...
> {
    ...
    sp_sender.send_to(
        &[privkey_deriv_path],
        example_rust_silentpayments::SilentPaymentAddress {
            version: sp_adderss.version,
            scan: sp_address.scan,
            spend: sp_address.spend,
            network: sp_address.network,
        },
    );
